...
<pre class="language-http"><code class="lang-http"><strong> 代码块
</strong><strong>1.POST /v1/jobs {
</strong>2.capability,
3.input,
4.selector
5.}
...
NodeX 所提供的「身體層」，解決了以下痛點（對應 VAE）：<br>

| 痛点          | NodeX 提供的身体能力           |
| ----------- | ----------------------- |
| AI 无法执行真实任务 | 能力虚拟化 + 设备 API          |
| 无法验证执行是否真实  | PoRW + ProofX           |
| 无机器身份，无法协作  | MID + RP/AP             |
| 缺少可信算力市场    | C2C Compute Marketplace |
| 云无法扩展到全球边缘  | 全球设备加入 NodeX 网络         |
