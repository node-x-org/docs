---
description: 專案官網：https://www.stable.xyz/
---
...
購買成功後，Node-X 將為你部署 stable 全節點。通常情況下，這個過程會在24小時內完成。你可以透過以下方式即時查看節點狀態：

1. 檢視節點狀態：\
   在 NodeX 平台的使用者面板中，你可以看到所有已購買的節點及其目前狀態。

## **結語**

透過 Node-X 平台部署stable 全節點就是這麼簡單！希望這篇指南對你有幫助。
